...
\begin{rSection}{Experience}
  ...
  \begin{rSubsection}{FRC 604: Quixilver Robotics}{2022 - Present}{Controls/Software Lead (10)}{California}
    ...
    \item Led team's global ranking to increase from \#71 to \#12 through leadership in robot design, manufacturing, programming, and strategic planning.
    
    \item Developed progressive web app for TheBlueAlliance, modernizing the widely-used platform providing real-time access to 30 years of competition and team data. Organized and attended 25+ community outreach events (science fairs, robot demos, conferences, etc).
  ...
  \begin{rSubsection}{UCLA COSMOS (CA Summer School for Mathematics \& Science)}{2024}{Brain-Inspired Computing Cohort Member}{California}
    ...
    \item Gained proficiency in 20+ key machine learning mechanisms under mentorship of Prof. Hugh Tad Blair. Explored intersection of neurobiological mechanisms and computing.
...
\begin{rSection}{Projects}
  ...
  \begin{rSubsection}{StereoSampleGAN}{}{GitHub Repo: \underline{\href{https://github.com/shuklabhay/stereo-sample-gan}{https://github.com/shuklabhay/stereo-sample-gan}}}{}
    ...
    \item Developed a WGAN-based approach for high-fidelity stereo audio sample generation. Leveraged attention mechanisms, optimized loss functions, and effective signal processing. Research partially funded by UCLA and pending publication.
  ...
  \begin{rSubsection}{Quickscout}{}{GitHub Organization: \underline{\href{https://github.com/frc604}{https://github.com/frc604}}}{}
    ...
    \item Developed a scalable scouting application for FRC event data collection and visualization. New captured metrics empower informed strategic decisions at high-stakes competitions, contributing to the team's international success.
        
    \item Supports 130+ users on FRC604, collected data for 750+ team robots over 2 years. Trained 10+ team members in web development to build application and expand capabilities to fit annual challenges.
