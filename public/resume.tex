...
\begin{rSection}{Experience}
  ...
  \begin{rSubsection}{Pavyl}{January 2025 - Present}{Software Advisor}{California}
    
    \item Advised on the creation of innovative large language model tools with unlimited context windows, enabling AI to grow with users and transforming AI-powered applications.
