...
\begin{rSection}{Experience}
  ...
  \begin{rSubsection}{Stanford Center for Biomedical Informatics Research}{November 2024 - Present}{Gevaert Lab Student Researcher}{California}
    ...
    \item Developed scalable Machine Learning/Computer Vision foundation models for segmenting microscopic to massive anatomical structures in medical imagery.
  ...
  \begin{rSubsection}{Pavyl}{January 2025 - Present}{Software Design Advisor}{California}
    ...
    \item Advised development of innovative large language model tools with unlimited context windows and effective user interfaces, enabling AI to grow with users and transforming AI-powered applications.
  ...
  \begin{rSubsection}{NEXUS Research Club}{August 2024 - Present}{Chapter Manager}{California}
    
    \item Coordinate with local leaders of 8+ NEXUS chapters in California high schools to ensure access to high-impact research opportunities and increase club membership.
