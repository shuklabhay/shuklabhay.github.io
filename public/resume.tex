...
\begin{rSection}{Experience}
  ...
  \begin{rSubsection}{Stanford Center for Biomedical Informatics Research}{November 2024 - Present}{Gevaert Lab Student Researcher}{California}
    ...
    \item Developed novel physics-based neural networks utilizing PDEs to transform single medical images into multiple anatomical states (varying breast compression levels, respiratory phases, cardiac cycles, etc), increasing training data diversity and helping model generalizability.
  ...
  \begin{rSubsection}{UCLA COSMOS (Brain-Inspired Computing/Artificial Intelligence Cohort)}{July 2024 - August 2024}{Student Researcher}{California}
    ...
    \item Developed neural networks to model rat hippocampus activity, perform image geolocation, and character recognition.
