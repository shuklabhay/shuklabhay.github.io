...
\begin{rSection}{Experience}
  ...
  \begin{rSubsection}{FRC 604: Quixilver Robotics}{2022 - Present}{Controls/Software Lead (10-11)}{California}
    ...
    \item Developed a progressive web app for TheBlueAlliance, modernizing the universally used platform and enabling effective, real-time access for FRC competition data and insights globally.
  ...
  \begin{rSubsection}{UCLA COSMOS (CA Summer School for Mathematics \& Science)}{2024}{Brain-Inspired Computing Cohort Member}{California}
    ...
    \item Developed StereoSampleGAN with UCLA funding to generate high quality stereo audio samples with a 99.5% reduction in training epoch count compared to monophonic, audio generation model SpecGAN.
    
  \end{rSubsection}
        
  \begin{rSubsection}{Bay Area STEM Academy}{2023 - Present}{Cofounder}{California}
    
    \item Impacted 700+ students with free STEM education, raised \$6000+ to support local STEM outreach initiatives for underrepresented communities and children health foundations.
    
    \item Developed engaging curriculum for elementary to high school students, recruited mentors, planned and effectively delivered numerous in-person and online camps covering Robotics, Engineering, Machine Learning, and Programming Fundamentals.
...
\begin{rSection}{Projects}
  ...
  \begin{rSubsection}{StereoSampleGAN}{}{GitHub Repo: \underline{\href{https://github.com/shuklabhay/stereo-sample-gan}{https://github.com/shuklabhay/stereo-sample-gan}}}{}
    ...
    \item Introduces a novel, computationally efficient WGAN-based approach for generating high-fidelity stereo audio samples. Leverages attention mechanisms, optimized loss functions, and effective signal processing while achieving a 99.5% reduction in training epoch count compared to SpecGAN.
