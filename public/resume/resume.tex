...
\begin{rSection}{Projects}
  ...
  \begin{rSubsection}{StereoSampleGAN}{}{GitHub Repo: \underline{\href{https://github.com/shuklabhay/stereo-sample-gan}{https://github.com/shuklabhay/stereo-sample-gan}}}{}
    ...
    \item WGAN-based computationally effiicent approach for generating high-fidelity stereo audio samples. Leverages attention mechanisms, optimized loss functions, and effective signal processing while achieving a 99.5\% reduction in training epoch count compared to SpecGAN.
