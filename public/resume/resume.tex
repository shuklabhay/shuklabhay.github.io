...
\begin{rSection}{Experience}
  ...
  \begin{rSubsection}{UCLA COSMOS (CA Summer School for Mathematics \& Science)}{2024}{Brain-Inspired Computing Cohort Member}{California}
    ...
    \item Developed StereoSampleGAN with UCLA funding to generate high quality stereo audio samples with a 99.77\% reduction in training epoch count compared to monophonic audio generation model SpecGAN.
    
  \end{rSubsection}
        
  \begin{rSubsection}{Bay Area STEM Academy}{2023 - Present}{Cofounder}{California}
    
    \item Taught 700+ elementary to high school students by planning and delivering numerous in-person and online workshops covering Robotics, Engineering, Machine Learning, and Programming Fundamentals.
...
\begin{rSection}{Projects}
  ...
  \begin{rSubsection}{StereoSampleGAN}{}{GitHub Repo: \underline{\href{https://github.com/shuklabhay/stereo-sample-gan}{https://github.com/shuklabhay/stereo-sample-gan}}}{}
    ...
    \item WGAN-based computationally effiicent approach for generating high-fidelity stereo audio samples. Leverages attention mechanisms, optimized loss functions, and effective signal processing while achieving a 99.77\% reduction in training epoch count compared to SpecGAN.
