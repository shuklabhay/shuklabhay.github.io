...
\begin{rSection}{Experience}
  ...
  \begin{rSubsection}{FRC 604: Quixilver Robotics}{2022 - Present}{Controls/Software Lead (10-11)}{California}
    ...
    \item Enhanced robot capabilities with computer vision and sensor integration, contributed to team software (particle filter localizer, time-optimal trajectory optimizer, annual robot control architecture). Developed team's competition data collection application Quickscout.
